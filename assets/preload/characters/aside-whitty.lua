...
function onCreate()
	makeLuaSprite('winningIcon', 'icons/win-bf'..getProperty('boyfriend.healthicon'), getProperty('iconP1.x'), getProperty('iconP1.y'))
	...
	makeLuaSprite('winningIconDad', 'icons/win-whitty'..getProperty('boyfriend.healthicon'), getProperty('iconP2.x'), getProperty('iconP2.y'))
